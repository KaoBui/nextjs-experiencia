  ...
  return (
    <section className="relative overflow-hidden px-4 py-[15vh]">
      <div className="mx-site-margin gap-space-2x flex flex-col items-center justify-center">
        ...
        <div className="p-space-base pt-space-2x gap-space-base flex max-w-xl flex-col items-end rounded-3xl bg-white/50 shadow-2xl/5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="aspect-square w-16 rounded-md">
              <Image src="/client-photo.jpg" width={100} height={100} alt="" />
            </div>
          </div>
        </div>
        <div className="gap-space-2x flex items-center justify-between opacity-25">
